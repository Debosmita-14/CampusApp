  ...
  return (
    <LinearGradient colors={theme.heroGradient} style={styles.container}>
      ...
      <Animated.View style={[styles.content, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
        ...
        <Text style={[styles.title, { color: isDark ? '#fff' : '#1e1b4b' }]}>Welcome Back</Text>
        <Text style={[styles.subtitle, { color: isDark ? '#a5b4fc' : '#6366f1' }]}>Sign in to your student account</Text>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? 'rgba(17, 24, 39, 0.6)' : 'rgba(255, 255, 255, 0.85)', borderColor: theme.cardBorder }]}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Signup')} style={styles.linkContainer}>
            <Text style={[styles.linkText, { color: theme.textSecondary }]}>
              Don't have an account? <Text style={[styles.linkBold, { color: theme.accent }]}>Sign Up</Text>
            </Text>
          </TouchableOpacity>
        </View>
      </Animated.View>
